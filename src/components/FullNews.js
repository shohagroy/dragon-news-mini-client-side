        ...
        <div className="rounded-md shadow-md m-4 bg-white text-gray-900">
            <div className="flex items-center justify-between p-3">
                <div className="flex items-center space-x-2">
                    ...
                    <div className="-space-y-1">
                        ...
                        <span className="inline-block text-xs leading-none text-gray-400">{author.published_date}</span>
                    </div>
                </div>
            ...
            <div className="p-3">
                ...
                <div className="flex flex-wrap items-center pt-3 pb-1">
                    <div className="flex items-center space-x-2">
                        ...
                        <span className="text-sm">Liked by 
                            <span className="font-semibold"> Shohag</span> and 
                             <span className="font-semibold"> { total_view } Other.</span>
                        </span>
                    </div>
                </div>
                <div className="space-y-3 text-left mt-5">
                    ...
                    <input type="text" placeholder="Add a comment..." className="w-full p-2 bg-transparent border-none rounded text-sm text-gray-900" />
                    <div className='text-right'>
                        <Link ><button className='bg-blue-400 text-white py-2 px-8 rounded-md'>Comment</button></Link>
                        <Link to={`../category/${category_id}`}><button className='bg-blue-400 text-white py-2 px-5 ml-2 rounded-md'>Back to Category</button></Link>
                    </div>
                </div>
            </div>
        </div>
