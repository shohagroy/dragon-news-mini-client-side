    ...
    return (
        <div className='flex justify-center items-center'>
            <div className="w-full max-w-md p-8 space-y-3 rounded-xl bg-white text-gray-900">
                ...
                text-red-600 text-2xl font-bold`}>{loginError.slice(5)}!</p>

                <form onSubmit={userLoginHandelar}  className="space-y-6 ng-untouched ng-pristine ng-valid">
                    ...
                    <button className="block w-full p-3 text-center rounded-sm text-white font-bold bg-blue-600">Log in</button>
                </form>
                ...
                <div className="flex justify-center space-x-4">
                    <button onClick={googleLoginHandelar} aria-label="Log in with Google" className="p-3 rounded-sm">
                ...
                <p className="text-xs text-center sm:px-6 text-gray-400">Don't have an account?
                    <Link to='/sign-up' rel="noopener noreferrer" href="#" className="underline text-gray-900">Sign up</Link>
                </p>
            </div>
        </div>
    );
